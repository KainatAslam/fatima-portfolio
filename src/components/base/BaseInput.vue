...
<template>
  <div class="flex flex-col gap-1.5 w-full">
    ...
    <input
      ...
      class="w-full px-4 py-3 rounded-card bg-surface border text-ink placeholder:text-muted/60 text-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus:ring-2 focus:ring-accent focus:border-accent"
